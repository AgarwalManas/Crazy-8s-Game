...
String currentSuit = "";
  ...
  players[0] = new ExtraCards( Arrays.copyOfRange(deck, 0, 3) );
  System.out.println("0 : " + Arrays.toString( Arrays.copyOfRange(deck, 0, 3))); 
  players[1] = new MindTheEights( Arrays.copyOfRange(deck, 4, 5) );
  System.out.println("1 : " + Arrays.toString( Arrays.copyOfRange(deck, 4, 5))); 
   players[2] = new MindTheEights( Arrays.copyOfRange(deck, 6, 11) );
  System.out.println("2 : " + Arrays.toString( Arrays.copyOfRange(deck,6,11))); 
...
//  win = false;
  ...
  while(!win ){
    ...
    scoreboard = game.score(scoreboard, player, people);
  /*
    ...
    for(int i = 0; i<scoreboard.length; i++){
      if(scoreboard[i] >= winningScore){
        score = true;
        System.out.println("----------------------THE OVERALL WINNER IS: Player "+ player);
      }
    }
   */
  }//while loop 2 end
