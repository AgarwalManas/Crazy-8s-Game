...
public class HamperLeaderTester{
...
String currentSuit = "";
  ...
  System.out.println("1 : " + Arrays.toString( Arrays.copyOfRange(deck, 5, 10))); 
   players[2] = new HamperLeader( Arrays.copyOfRange(deck, 10, 15) );
